 ...
 *
 * search() and query() are not overloaded with the __call() method, this is because queries require urlencoding. I'm
 * open to a more elegant solution, but prefer to leave it this way to make it simple to use.
 */
